                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="nav-four" role="tabpanel" aria-labelledby="nav-tab-4">
                                    <div class="py-3">
                                        <div class="row align-items-center">
                                            <div class="col-md-12 text-center">
                                                <img class="img-fluid text-center" src="{{ asset('assets/img/resources/culqi.png') }}">
                                            </div>
