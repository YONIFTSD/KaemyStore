                    ...
                    <div class="product_d_right">
                       <form action="#">
                        ...
                        <div class="priduct_social pt-2">
                            <ul class="ul-list">
                                <li class="ico-facebook"><a href="https://www.facebook.com/kaemy.sac" target="_blank" title="Facebook"><i class="fab fa-facebook-f"></i></a></li>           
                                <li class="ico-instagram"><a href="/" target="_blank" title="Instagram"><i class="fab fa-instagram"></i></a></li>           
