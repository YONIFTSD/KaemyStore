            ...
            <div class="col-12">
                <div class="Offcanvas_menu_wrapper">
                    ...
                    <div class="support_info">
                        <p><a class="font-helvetica" href="mailto:contacto@tiendaskaemy.com">contacto@tiendaskaemy.com</a></p>
...
<header class="header">
                        ...
                        <div class="text-center text-md-right">
                            <div class="d-sm-flex align-items-center justify-content-center justify-content-md-end">
                                <div class="d-flex align-items-center justify-content-center mr-0 pr-0 py-1 mr-md-2 pr-md-2">
                                    ...
                                    <div class="ml-2 text-dark font-helvetica">contacto@tiendaskaemy.com</div>
                                </div>
                                <div class="d-flex align-items-center justify-content-center ml-0 pl-0 py-1 ml-md-2 pl-md-2 mr-md-2 pr-md-2">
                                    ...
                                    <div class="ml-1 text-dark font-helvetica">+51 993945530</div>
                                </div>

                                <ul class="list-top-l">
                                    <li><a class="text-dark font-helvetica" href="{{ url('my-account') }}">Mi cuenta</a></li>
                                    <li><a class="text-dark font-helvetica" href="{{ url('contactenos') }}">Contacto</a></li>
                                </ul>
                                @php
                                ...
                                <div class="bg-cart mr-0">
                                    <a href="{{ url('mi-carrito') }}" class="link-cart d-flex align-items-center justify-content-center py-2 ml-0 ml-md-3 mr-md-3">
                                        <span class="ico-cart mr-2 text-white"></span>
                                        <span class="text-uppercase text-cart-i pr-1 text-white">Carrito  </span>
                                        <span id="my-cart-number text-white" class="my-cart-number">{{$totalc}}</span>
    ...
    <div class="header-middle">
        <div class="container-fluid">
            ...
            <div class="row">
                <!-- col -->
                <div class="col-12 col-sm-12 col-md-12 col-lg-3 bg-header-logo d-flexs align-items-center">
                    <div class="brand-header mt-2 py-2 text-center text-md-center">
                        <a href="{{ url('/') }}">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-9">
                    <div class="w-100 text-right mb-2 d-none d-lg-block mt-1">
                        ...
                        <div class="link-vm">
                            <a href="https://www.facebook.com/kaemy.sac" target="_blank"><img src="{{ asset('assets/img/resources/facebook.png') }}"></a>
                        </div>
                        ...
                        <div class="main_menu menu_position"> 
                            <nav>  
                                <ul class="main_menu_nav_ul">
                                    ...
                                    @php
                                    $categories = \App\Models\Category::GetCategory();
                                    @endphp
