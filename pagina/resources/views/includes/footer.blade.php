                    ...
                    <div class="col-12 col-md-6 col-lg-3 py-3">
                        <div class="footer__widget footer-contacts">
                            ...
                            <ul class="footer-contacts__contacts footer-list pt-2">
                                ...
                                <li class="d-flex align-items-center"><i class="footer-contacts__icon fas fa-envelope"></i><span>contacto@tiendaskaemy.com</span></li>
                                <li class="d-flex align-items-center"><i class="footer-contacts__icon fas fa-globe-americas"></i><span>tiendaskaemy.com</span></li>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="footer__copyright text-lg-left text-center">
                            <div class="text-copyright">Copyright © 2020 - Tiendas Kaemy  - Perú  - Todos los derechos reservados</div>
                        </div>
                    </div>
                    <div class="col-md-6 text-right">
                        <div class="footer__copyright text-lg-right text-center">
                            <div class="text-dev">Diseño: <a href="/" target="_blank">Soft Evolution</a></div>
                        </div>
                    </div>
                </div>
            </div>
